...
#+SETUPFILE: https://piratesands2.gitlab.io/org-html-themes/setup/theme-readtheorg.setup
...
1. You *add a* =#+SETUPFILE:= *directive* in the preamble of your document (to include
   ...
   ,#+SETUPFILE: https://piratesands2.gitlab.io/org-html-themes/setup/THEME-NAME.setup
   #+end_src
